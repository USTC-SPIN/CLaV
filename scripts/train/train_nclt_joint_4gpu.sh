...
# 配置文件
#CONFIG_FILE="configs/nclt_joint_training.yaml"
CONFIG_FILE="configs/nclt_stage2_training.yaml"
...
echo ""
export CUDA_VISIBLE_DEVICES=0,1,2,3  # 使用前4张卡
...
echo -e "${BLUE}========================================"
echo "开始NCLT联合训练 - 4卡并行"
echo "======================================${NC}"
echo -e "${YELLOW}训练模式: 联合训练 (去噪 + 描述符)${NC}"
